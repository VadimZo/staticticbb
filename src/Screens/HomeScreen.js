...
export const HomeScreen = () => {
  return (
    <div className="">
      <div className="h-screen bg-bb-sm sm:bg-bb-lg sm:bg-bottom bg-no-repeat bg-cover ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 place-content-center">
            <div className="md:col-span-full">
              ...
              <h2 className="text-gray-100 text-3xl text-center mt-2">
                Statistics, Shot Charts,and good players :)
              </h2>
            </div>
            <div className="grid md:col-span-full md:grid-cols-5 mt-6 md:mt-0">
              <Link
                ...
                to="/player/lebron"
              >
                <button className="bg-lakers md:my-8 lg:my-16  justify-self-center font-bold text-5xl py-3 md:py-6 px-7 md:px-14  rounded-3xl text-white">
                  Try Us
                </button>
              </Link>
            </div>
